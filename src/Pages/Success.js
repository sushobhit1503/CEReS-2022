            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", paddingTop: "130px" }}>
                <div className="land-container">
                    ...
                    <div style={{ display: "flex", flexDirection: "column", boxShadow: "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px", margin: "10px 0px 30px 0px", padding: "10px", width: "30%", borderRadius: "10px" }}>
                        ...
                        <Input onChange={onChange} value={this.state.category} name="category" type="text" disabled={true} style={{ marginBottom: "15px" }} placeholder="Ticket Category" />
                ...
                <div style={{ display: "flex", justifyContent: "center", marginBottom: "50px" }}>
                    {!disabled ? <button style={{ border: "none", outline: "none", backgroundColor: "var(--blue-color)", padding: "15px", width: "max-content", borderRadius: "10px", color: "var(--yellow-color)", fontWeight: "600", alignItems: "center" }}>
                        BUY TICKETS
                    </button> :
